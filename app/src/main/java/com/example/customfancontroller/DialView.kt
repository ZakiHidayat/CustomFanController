...
class DialView @JvmOverloads constructor(
    ...
    private fun PointF.computedXYForSpeed(pos : FanSpeed, radius : Float){
...
//        paint.color = if (fanSpeed == FanSpeed.OFF) Color.GRAY else Color.GREEN
        ...
        pointPosition. computedXYForSpeed(fanSpeed, markerRadius)
        ...
        for (i in FanSpeed.values()) {
            pointPosition.computedXYForSpeed(i, labelRadius)
